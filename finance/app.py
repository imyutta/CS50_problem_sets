...
def index():
    ...
    return render_template("index.html", users_stocks=users_stocks, users_cash=users_cash, total_amount=total_amount, total_value=total_value)
