...
char random_allele();
bool is_true_allele(char tmp_allele, person *parent0, person *parent1, int i);
...
bool is_true_allele(char tmp_allele, person *parent0, person *parent1, int i)
{
    ...
    if (i == 0)
    {
        if (tmp_allele == parent0->alleles[0] || tmp_allele == parent0->alleles[1])
        {
            return true;
        }
        else
    ...
    if (i == 1)
    {
        if (tmp_allele == parent1->alleles[0] || tmp_allele == parent1->alleles[1])
        {
            return true;
        }
        else
